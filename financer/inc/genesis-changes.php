...
add_filter( 'theme_page_templates', 'fs_remove_genesis_templates' );
...
add_filter( 'genesis_search_form', 'fs_search_form' );
...
add_filter( 'genesis_customizer_theme_settings_config', 'fs_disable_customizer_theme_settings' );

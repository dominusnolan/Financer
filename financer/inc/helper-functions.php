...
global $wp_embed;
add_filter( 'fs_the_content', array( $wp_embed, 'run_shortcode' ), 8 );
add_filter( 'fs_the_content', array( $wp_embed, 'autoembed'     ), 8 );
add_filter( 'fs_the_content', 'wptexturize'        );
add_filter( 'fs_the_content', 'convert_chars'      );
add_filter( 'fs_the_content', 'wpautop'            );
add_filter( 'fs_the_content', 'shortcode_unautop'  );
add_filter( 'fs_the_content', 'do_shortcode'       );
 ...
 */
function fs_class( $base_classes, $optional_class, $conditional ) {

...
// Add new layouts
genesis_register_layout( 'content', [ 'label' => __( 'Content', 'fs_genesis_child' ), ] );
 ...
 *
 */
function fs_editor_layout_style() {
...
add_action( 'enqueue_block_editor_assets', 'fs_editor_layout_style' );
 ...
 * @return string
 */
function fs_editor_layout_class( $classes ) {
...
add_filter( 'admin_body_class', 'fs_editor_layout_class' );

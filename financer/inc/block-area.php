...
class fs_Block_Area {
	...
	/**
	 * Class Instance.
	 * @return fs_Block_Area
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof fs_Block_Area ) ) {
			self::$instance = new fs_Block_Area();
 ...
 * @return object
 */
function fs_block_area() {
	return fs_Block_Area::instance();
}
fs_block_area();
